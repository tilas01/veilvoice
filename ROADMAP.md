...
3. **169**, immediately after. 167 left the indicator behind it, one function
   with the honest-estimate rule built in, so this is the sweep rather than the
   invention: twelve panels still draw a bare spinner of their own, and none of
   them, the new one included, consults the reduce-motion setting yet.
