...
sh reproduce-veilvoice.sh v0.1.19
```
...
- **51272 functional lines of Rust**, across 28 crates. A *functional line* is
...
**v0.1.19: early but real.** The engine, cryptography, audio path, metadata
cleaning, at-rest encryption, app lock, tamper detection, encrypted-volume
destinations, CLI and GUI are implemented and tested (1393 tests across 27
...
Thirty audit rounds have found and fixed **158 defects**.
