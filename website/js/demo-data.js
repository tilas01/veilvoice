...
window.VEILVOICE_DEMO = {
  ...
  "usecases": [
    ...
    {
      "note": "The one mistake here that cannot be heard in the result: every voice in a veiled recording is unfamiliar, so nobody notices one person rendered in another's voice. Corrected before the render, which is the only time it can be, and keyed on the moment you heard it rather than on a span number you would have to go and count.",
      "title": "Fix a stretch given to the wrong person",
      "typed": "veilvoice conversation fix interview.toml reassign --at 20 --to 2"
    },
    {
