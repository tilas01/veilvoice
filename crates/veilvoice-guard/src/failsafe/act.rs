...
//!
//! [`crate::failsafe::Guard::look`] already worked out whether a program may be closed,
...
///
/// Refuses anything on [`crate::failsafe::PROTECTED`] whatever the caller believed, and
...
pub fn close(app: &str, pid: Option<u32>) -> Result<String, String> {
    if crate::failsafe::is_protected(app) {
        return Err(format!(
