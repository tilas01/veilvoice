...
<p align="center">
  <img src="../../assets/banners/veilvoice-policy.svg" alt="veilvoice-policy" width="62%">
</p>
...
| [`policy.rs`](../../docs/files/veilvoice-policy/policy.md) | 991 | The policy itself: what can be required, and what requiring it does. |
...
| `fn utc` | [`mandate.rs`](../../docs/files/veilvoice-policy/mandate.md) | Unix seconds as YYYY-MM-DD HH:MM:SS UTC. |
