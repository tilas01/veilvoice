...
|---|---:|---|
| [`lib.rs`](../../docs/files/veilvoice-conversation/lib.md) | 163 | Several people in one recording: a plan of who spoke when, a distinct destination voice for each of them, and subtitles that carry their names. |
