...
<p align="center">
  <img src="../../assets/banners/veilvoice-cli.svg" alt="veilvoice-cli" width="62%">
</p>
...
| [`guard.rs`](../../docs/files/veilvoice-cli/guard.md) | 362 | veilvoice guard -- record what VeilVoice's files should be, and check them. |
...
| [`main.rs`](../../docs/files/veilvoice-cli/main.md) | 3680 | veilvoice, the command-line interface. |
...
| [`sentry.rs`](../../docs/files/veilvoice-cli/sentry.md) | 386 | veilvoice sentry -- canaries, baselines, and what changed since. |
...
| `fn insist` | [`mandate.rs`](../../docs/files/veilvoice-cli/mandate.md) | Insist on one or both requirements again. |
| `fn reset` | [`mandate.rs`](../../docs/files/veilvoice-cli/mandate.md) | Back to insisting on both. |
...
| `fn run` | [`update.rs`](../../docs/files/veilvoice-cli/update.md) | Run the command. |
