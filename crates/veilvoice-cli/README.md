...
| [`lock.rs`](../../docs/files/veilvoice-cli/lock.md) | 319 | veilvoice lock — manage the application lock from the command line. |
| [`main.rs`](../../docs/files/veilvoice-cli/main.md) | 2365 | veilvoice — the command-line interface. |
