...
| [`conversation.rs`](../../docs/files/veilvoice-cli/conversation.md) | 647 | veilvoice conversation -- several speakers, a voice each, and subtitles. |
...
| [`main.rs`](../../docs/files/veilvoice-cli/main.md) | 1923 | veilvoice — the command-line interface. |
...
| `fn list` | [`capture.rs`](../../docs/files/veilvoice-cli/capture.md) | Every program in the table, whether it is running or not. |
