...
flowchart TD
    ...
    n_settings["settings.rs<br/>1662 lines"]
...
|---|---:|---|
| [`app.rs`](../../docs/files/veilvoice-gui/app.md) | 3643 | The VeilVoice desktop application: seven tabs, one window, no menus. |
...
| [`settings.rs`](../../docs/files/veilvoice-gui/settings.md) | 1662 | The settings panel: a menu of pages, each a titled group of choices. |
...
| [`tour.rs`](../../docs/files/veilvoice-gui/tour.md) | 579 | The short tour on a first run, and after an upgrade. |
...
**19,613 functional lines of Rust** in this crate. A functional line is a line
...
| `fn all_keys` | [`tour.rs`](../../docs/files/veilvoice-gui/tour.md) | Every tab key the tour knows, for storing once it has run. |
