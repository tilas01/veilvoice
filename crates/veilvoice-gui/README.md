...
flowchart TD
    ...
    n_group["group.rs<br/>1525 lines"]
...
| [`group.rs`](../../docs/files/veilvoice-gui/group.md) | 1525 | Group mode: several people in one recording, each with a name and a colour. |
