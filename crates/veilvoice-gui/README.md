...
|---|---:|---|
| [`app.rs`](../../docs/files/veilvoice-gui/app.md) | 3688 | The VeilVoice desktop application: seven tabs, one window, no menus. |
...
**20,426 functional lines of Rust** in this crate. A functional line is a line
