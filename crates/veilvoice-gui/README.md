...
flowchart TD
    ...
    n_prefs["prefs.rs<br/>469 lines"]
    n_reduced_motion["reduced_motion.rs<br/>348 lines"]
    n_security["security.rs<br/>1111 lines"]
...
|---|---:|---|
| [`app.rs`](../../docs/files/veilvoice-gui/app.md) | 1845 | The VeilVoice desktop application: seven tabs, one window, no menus. |
...
| [`prefs.rs`](../../docs/files/veilvoice-gui/prefs.md) | 469 | What the user has chosen about how the app looks and moves. |
...
| [`security.rs`](../../docs/files/veilvoice-gui/security.md) | 1111 | The application lock, and the at-rest encryption of what VeilVoice writes. |
