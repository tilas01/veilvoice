...
flowchart TD
    n_lib(["lib.rs<br/>58 lines"])
    n_main(["main.rs<br/>87 lines"])
    n_app["app.rs<br/>1110 lines"]
...
|---|---:|---|
| [`app.rs`](../../docs/files/veilvoice-gui/app.md) | 1110 | The VeilVoice desktop application: six tabs, one window, no menus. |
| [`crashlog.rs`](../../docs/files/veilvoice-gui/crashlog.md) | 254 | Make a failure that produces no output produce some. |
| [`lib.rs`](../../docs/files/veilvoice-gui/lib.md) | 58 | The VeilVoice desktop application: an egui/eframe front-end, monospace throughout — anonymise a file, scramble a microphone live, watch what is listening, manage the app lock, choose how the app looks, and an about panel that states the honest scope. |
...
| [`reduced_motion.rs`](../../docs/files/veilvoice-gui/reduced_motion.md) | 324 | Whether the operating system has been asked to reduce motion. |
