...
<p align="center">
  <img src="../../assets/banners/veilvoice-gui.svg" alt="veilvoice-gui" width="62%">
</p>
...
flowchart TD
    n_lib(["lib.rs<br/>1052 lines"])
    n_main(["main.rs<br/>269 lines"])
    n_app["app.rs<br/>3647 lines"]
    ...
    n_firstrun["firstrun.rs<br/>863 lines"]
    n_graphics["graphics.rs<br/>214 lines"]
    n_group["group.rs<br/>2111 lines"]
    ...
    n_offthread["offthread.rs<br/>265 lines"]
    ...
    n_verify["verify.rs<br/>1834 lines"]
    n_watchfeed["watchfeed.rs<br/>412 lines"]
    n_window["window.rs<br/>249 lines"]
    n_app --> n_avnotice
    n_app --> n_crashlog
    n_app --> n_crashreport
    n_app --> n_dialog
    ...
    click n_offthread href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/offthread.rs" "open the source"
    click n_pace href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/pace.rs" "open the source"
...
|---|---:|---|
| [`app.rs`](../../docs/files/veilvoice-gui/app.md) | 3647 | The VeilVoice desktop application: seven tabs, one window, no menus. |
...
| [`firstrun.rs`](../../docs/files/veilvoice-gui/firstrun.md) | 863 | The first run: the four things worth deciding before anything else. |
...
| [`group.rs`](../../docs/files/veilvoice-gui/group.md) | 2111 | Group mode: several people in one recording, each with a name and a colour. |
...
| [`lib.rs`](../../docs/files/veilvoice-gui/lib.md) | 1052 | The VeilVoice desktop application: an egui/eframe front-end, monospace throughout: anonymise a file, scramble a microphone live, watch what is listening, manage the app lock, choose how the app looks, and an about panel that states the honest scope. |
...
| [`offthread.rs`](../../docs/files/veilvoice-gui/offthread.md) | 265 | One answer, worked out somewhere that is not the thread drawing the window. |
...
| [`palettes.rs`](../../docs/files/veilvoice-gui/palettes.md) | 714 | User-defined colour schemes, and the contrast check that keeps them usable. |
...
| [`prefs.rs`](../../docs/files/veilvoice-gui/prefs.md) | 1012 | What the user has chosen about how the app looks and moves. |
| [`probe.rs`](../../docs/files/veilvoice-gui/probe.md) | 426 | What this machine answers, so the settings it starts on were measured here. |
| [`progress.rs`](../../docs/files/veilvoice-gui/progress.md) | 345 | How far through a job is, in the two cases that exist: the ones that can honestly say, and the ones that cannot. |
...
| [`setup.rs`](../../docs/files/veilvoice-gui/setup.md) | 1165 | The setup tab: install this copy, undo that, and the optional companions. |
...
| [`studio.rs`](../../docs/files/veilvoice-gui/studio.md) | 2762 | The Recording Studio and the Recording Browser. |
...
| [`vault_store.rs`](../../docs/files/veilvoice-gui/vault_store.md) | 807 | Where the desktop application keeps its own files, and what the app lock buys for them. |
| [`verify.rs`](../../docs/files/veilvoice-gui/verify.md) | 1834 | The verify tab: drop a download on the window and be told what it is. |
...
**21,582 functional lines of Rust** in this crate. A functional line is a line
...
| `const DEFAULT_SECS` | [`autolock.rs`](../../docs/files/veilvoice-gui/autolock.md) | The delay a fresh installation uses: half an hour. |
...
| `const NEW_ISSUE` | [`crashreport.rs`](../../docs/files/veilvoice-gui/crashreport.md) | Where a report goes, if the person wants to file one. |
| `const ISSUES` | [`crashreport.rs`](../../docs/files/veilvoice-gui/crashreport.md) | The issue tracker itself, linked from About whether or not anything crashed. |
| `struct Offer` | [`crashreport.rs`](../../docs/files/veilvoice-gui/crashreport.md) | What the panel is showing, kept across frames. |
| `struct Advice` | [`decoys.rs`](../../docs/files/veilvoice-gui/decoys.md) | What to offer, and on what evidence. |
| `fn advise` | [`decoys.rs`](../../docs/files/veilvoice-gui/decoys.md) | Work out what to offer from the vault's shape and whatever the disk says. |
...
| `fn asked_for` | [`graphics.rs`](../../docs/files/veilvoice-gui/graphics.md) | What was asked of the platform, in the words the About tab uses. |
...
| `struct Levels` | [`monitor.rs`](../../docs/files/veilvoice-gui/monitor.md) | The smoothed levels the monitor and the Studio both draw. |
...
| `fn meter` | [`monitor.rs`](../../docs/files/veilvoice-gui/monitor.md) | One level meter: a bar on the decibel scale, and the number beside it. |
...
| `struct Answer` | [`offthread.rs`](../../docs/files/veilvoice-gui/offthread.md) | One value, worked out off the drawing thread. |
| `const DISPLAY_FLOOR` | [`pace.rs`](../../docs/files/veilvoice-gui/pace.md) | The lowest rate a display is believed to have. |
| `const DISPLAY_CEILING` | [`pace.rs`](../../docs/files/veilvoice-gui/pace.md) | The highest rate the window will run at, display or setting. |
| `const ASSUMED` | [`pace.rs`](../../docs/files/veilvoice-gui/pace.md) | The rate assumed until the display has been measured. |
| `const TARGETS` | [`pace.rs`](../../docs/files/veilvoice-gui/pace.md) | The targets Settings offers, besides "match the display". |
| `fn next_frame` | [`pace.rs`](../../docs/files/veilvoice-gui/pace.md) | Ask for the next frame the way the current target wants it asked for. |
| `enum Target` | [`pace.rs`](../../docs/files/veilvoice-gui/pace.md) | What a person chose in Settings. |
| `struct Pace` | [`pace.rs`](../../docs/files/veilvoice-gui/pace.md) | The measurement, kept across frames. |
...
| `struct Where` | [`paths.rs`](../../docs/files/veilvoice-gui/paths.md) | One place VeilVoice keeps something, and what it keeps there. |
| `fn arrangement` | [`paths.rs`](../../docs/files/veilvoice-gui/paths.md) | Which of the two arrangements this copy is using, in one sentence. |
| `fn all` | [`paths.rs`](../../docs/files/veilvoice-gui/paths.md) | Every location, in the order the About tab shows them. |
| `fn carry_over` | [`paths.rs`](../../docs/files/veilvoice-gui/paths.md) | Copy a portable copy's state into the platform's own configuration directory, without overwriting anything already there. |
...
| `struct Reach` | [`progress.rs`](../../docs/files/veilvoice-gui/progress.md) | How far through one job is. |
...
| `fn badge` | [`soundbar.rs`](../../docs/files/veilvoice-gui/soundbar.md) | Draw the mark at size, returning the response so it can carry a tooltip. |
...
| `fn jetbrains_mono_path` | [`theme.rs`](../../docs/files/veilvoice-gui/theme.md) | Where JetBrains Mono is on this machine, if it is anywhere. |
...
| `const CARDS` | [`tour.rs`](../../docs/files/veilvoice-gui/tour.md) | One card: the tab it is about, and what that tab is for. |
| `enum Stage` | [`tour.rs`](../../docs/files/veilvoice-gui/tour.md) | One stop on the walkthrough. |
| `struct Already` | [`tour.rs`](../../docs/files/veilvoice-gui/tour.md) | What is already true, so the tour can leave out what it would only repeat. |
| `fn stages` | [`tour.rs`](../../docs/files/veilvoice-gui/tour.md) | Every stop, in the order a reader meets them. |
| `struct Tour` | [`tour.rs`](../../docs/files/veilvoice-gui/tour.md) | Where the tour is up to. |
| `fn all_keys` | [`tour.rs`](../../docs/files/veilvoice-gui/tour.md) | Every stop's name, for storing once the tour has run. |
| `enum Outcome` | [`tour.rs`](../../docs/files/veilvoice-gui/tour.md) | What the window should do once the tour is out of the way. |
| `struct Updates` | [`updates.rs`](../../docs/files/veilvoice-gui/updates.md) | The panel's state. |
| `mod records` | [`vault_store.rs`](../../docs/files/veilvoice-gui/vault_store.md) | The logical names of every record the application keeps. |
| `struct VaultStore` | [`vault_store.rs`](../../docs/files/veilvoice-gui/vault_store.md) | The application's own storage, locked or not. |
| `struct Measured` | [`vault_store.rs`](../../docs/files/veilvoice-gui/vault_store.md) | What the application measured about its own running, kept between sessions. |
| `struct Report` | [`verify.rs`](../../docs/files/veilvoice-gui/verify.md) | Everything one press of check found out. |
| `struct Contents` | [`verify.rs`](../../docs/files/veilvoice-gui/verify.md) | What the extracted folder turned out to hold. |
| `struct Gnupg` | [`verify.rs`](../../docs/files/veilvoice-gui/verify.md) | What this machine's GnuPG said. |
