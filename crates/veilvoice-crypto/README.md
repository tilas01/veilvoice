...
flowchart TD
    ...
    n_studio["studio.rs<br/>936 lines"]
...
| [`studio.rs`](../../docs/files/veilvoice-crypto/studio.md) | 936 | The studio vault: a key that exists only when both locks have been opened. |
...
**5,791 functional lines of Rust** in this crate. A functional line is a line
