...
flowchart TD
    ...
    n_weave["weave.rs<br/>1557 lines"]
    n_hoard --> n_amnesia
...
| [`weave.rs`](../../docs/files/veilvoice-crypto/weave.md) | 1557 | Thirty-one reversible encodings, chosen at random, applied around the encryption -- before it, after it, or both. |
...
**6,790 functional lines of Rust** in this crate. A functional line is a line
