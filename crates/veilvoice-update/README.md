...
|---|---:|---|
| [`lib.rs`](../../docs/files/veilvoice-update/lib.md) | 583 | Ask, only when told to, whether a newer VeilVoice release exists. |
| [`ask.rs`](../../docs/files/veilvoice-update/examples-ask.md) | 26 | Run the real check once, by hand. |

**354 functional lines of Rust** in this crate. A functional line is a line
