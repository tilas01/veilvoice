...
<p align="center">
  <img src="../../assets/banners/veilvoice-failsafe.svg" alt="veilvoice-failsafe" width="100%">
</p>
...
<p align="center">
  <img src="../../assets/diagrams/veilvoice-failsafe.svg" alt="how veilvoice-failsafe fits together" width="640">
</p>
...
|---|---:|---|
| [`act.rs`](../../docs/files/veilvoice-failsafe/act.md) | 470 | Actually closing a program, kept apart from deciding to. |
...
| Item | Where | What |
|---|---|---|
| `fn close` | [`act.rs`](../../docs/files/veilvoice-failsafe/act.md) | Close a program, having decided it should be closed. |
| `enum Posture` | [`lib.rs`](../../docs/files/veilvoice-failsafe/lib.md) | How hard Failsafe acts when it finds something. |
| `const PROTECTED` | [`lib.rs`](../../docs/files/veilvoice-failsafe/lib.md) | Processes Failsafe will never close, whatever they are holding. |
| `fn is_protected` | [`lib.rs`](../../docs/files/veilvoice-failsafe/lib.md) | Whether this program is one Failsafe refuses to close. |
| `enum Finding` | [`lib.rs`](../../docs/files/veilvoice-failsafe/lib.md) | What Failsafe found. |
| `struct Action` | [`lib.rs`](../../docs/files/veilvoice-failsafe/lib.md) | One thing Failsafe did, for the record. |
| `struct Holder` | [`lib.rs`](../../docs/files/veilvoice-failsafe/lib.md) | What the watch feed says about one application holding a device. |
| `struct Guard` | [`lib.rs`](../../docs/files/veilvoice-failsafe/lib.md) | The state Failsafe needs to decide anything. |
| `const CANNOT_PREVENT` | [`lib.rs`](../../docs/files/veilvoice-failsafe/lib.md) | What Failsafe cannot do, in the words a front end must show. |
| `const NEVER_CLOSES` | [`lib.rs`](../../docs/files/veilvoice-failsafe/lib.md) | What Failsafe refuses to close, and why. |

## Reading it elsewhere

- On the website: [`website/reference/veilvoice-failsafe.html`](../../website/reference/veilvoice-failsafe.html)
