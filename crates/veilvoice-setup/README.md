...
flowchart TD
    ...
    n_companions["companions.rs<br/>1024 lines"]
...
|---|---:|---|
| [`companions.rs`](../../docs/files/veilvoice-setup/companions.md) | 1024 | Optional third-party software, detected rather than assumed. |
...
| `fn covers` | [`volumes.rs`](../../docs/files/veilvoice-setup/volumes.md) | Whether path is inside one of mounts right now. |
