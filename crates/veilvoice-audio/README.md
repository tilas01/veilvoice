...
flowchart TD
    ...
    n_devices["devices.rs<br/>248 lines"]
    n_io["io.rs<br/>574 lines"]
    n_live["live.rs<br/>860 lines"]
...
|---|---:|---|
| [`devices.rs`](../../docs/files/veilvoice-audio/devices.md) | 248 | Enumerating audio devices, and guessing which of them are virtual cables. |
...
| [`live.rs`](../../docs/files/veilvoice-audio/live.md) | 860 | Live microphone scrambling. |
