...
*This page is [`docs/PACKAGING.md`](https://github.com/tilas01/veilvoice/blob/main/docs/PACKAGING.md) in the repository. The repository copy is the source; this is the same text with its links rewritten for the wiki.*

<!-- SPDX-License-Identifier: GPL-3.0-or-later -->

# Packaging

Package definitions for the platforms that have one, in [`packaging/`](https://github.com/tilas01/veilvoice/blob/main/packaging).
