...
flowchart TD
    ...
    n_tests["tests.rs<br/>1671 lines"]
    n_builder --> n_deps
...
|---|---:|---|
| [[`builder.rs`|File-veilvoice-verify-builder]] | 1210 | Build VeilVoice here, and compare what came out against what was published. |
...
| [[`lib.rs`|File-veilvoice-verify-lib]] | 2252 | The portable verifier: check a VeilVoice release without GnuPG installed. |
| [[`report.rs`|File-veilvoice-verify-report]] | 385 | How much this program says, and what it returns when it says nothing. |
| [[`tests.rs`|File-veilvoice-verify-tests]] | 1671 | The verifier's own tests. |
...
**7,822 functional lines of Rust** in this crate. A functional line is a line
