...
flowchart TD
    ...
    n_tests["tests.rs<br/>1388 lines"]
    n_builder --> n_deps
...
| [[`lib.rs`|File-veilvoice-verify-lib]] | 1918 | The portable verifier: check a VeilVoice release without GnuPG installed. |
| [[`report.rs`|File-veilvoice-verify-report]] | 385 | How much this program says, and what it returns when it says nothing. |
| [[`tests.rs`|File-veilvoice-verify-tests]] | 1388 | The verifier's own tests. |
| [[`release_manifest.rs`|File-veilvoice-verify-tests-release_manifest]] | 208 | Roadmap item 97. |

**6,602 functional lines of Rust** in this crate. A functional line is a line
