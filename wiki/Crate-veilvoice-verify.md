...
| [[`tests.rs`|File-veilvoice-verify-tests]] | 723 | The verifier's own tests. |
| [[`release_manifest.rs`|File-veilvoice-verify-tests-release_manifest]] | 208 | Marker 97. |

**3,954 functional lines of Rust** in this crate. A functional line is a line
