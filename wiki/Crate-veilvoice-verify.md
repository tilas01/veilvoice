...
flowchart TD
    ...
    n_tests["tests.rs<br/>1356 lines"]
    n_builder --> n_deps
...
| [[`tests.rs`|File-veilvoice-verify-tests]] | 1356 | The verifier's own tests. |
| [[`release_manifest.rs`|File-veilvoice-verify-tests-release_manifest]] | 208 | Marker 97. |

**4,412 functional lines of Rust** in this crate. A functional line is a line
