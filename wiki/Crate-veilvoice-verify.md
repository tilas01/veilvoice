...
| [[`tests.rs`|File-veilvoice-verify-tests]] | 846 | The verifier's own tests. |
| [[`release_manifest.rs`|File-veilvoice-verify-tests-release_manifest]] | 208 | Marker 97. |

**4,042 functional lines of Rust** in this crate. A functional line is a line
