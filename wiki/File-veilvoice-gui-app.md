...
[[veilvoice-gui|Crate-veilvoice-gui]] &middot; 3584 lines &middot; [read the source](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/app.rs)
...
| `VeilVoiceApp::poll_job` <sub>fn</sub> | [1513](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/app.rs#L1513) | Take the result of a finished job without ever waiting for one. |
| `VeilVoiceApp::settings` <sub>fn</sub> | [1549](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/app.rs#L1549) | Draw the settings panel, with a policy floor shown as a floor rather than as a value somebody can move. |
| `VeilVoiceApp::file_tab` <sub>fn</sub> | [1661](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/app.rs#L1661) | Draw the File tab: pick a recording, veil it, write it somewhere else. |
| `VeilVoiceApp::start_job` <sub>fn</sub> | [1771](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/app.rs#L1771) | Hand the work to a thread, so the window keeps drawing while it runs. |
| `VeilVoiceApp::guest_list` <sub>fn</sub> | [1882](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/app.rs#L1882) | The Recording Studio: the voice first, then the take. |
| `VeilVoiceApp::studio_tab` <sub>fn</sub> | [1959](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/app.rs#L1959) | Draw the Recording Studio: record into the vault, veiled on the way in. |
| `VeilVoiceApp::start_preview` <sub>fn</sub> | [2322](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/app.rs#L2322) | Veil to this machine's own output, and say where it is going. |
| `VeilVoiceApp::check_failsafe` <sub>fn</sub> | [2374](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/app.rs#L2374) | Ask the safety catch what it makes of what is holding a microphone. |
| `VeilVoiceApp::watch_indicator` <sub>fn</sub> | [2450](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/app.rs#L2450) | Re-scan on a timer rather than every frame. |
