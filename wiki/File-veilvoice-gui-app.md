...
[[veilvoice-gui|Crate-veilvoice-gui]] &middot; 3626 lines &middot; [read the source](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/app.rs)
...
3626 lines defining **34 functions** (3 public), **3 types** and **1 constant**. Everything below is read out of the source, so it cannot disagree with the code.
...
flowchart TD
    ...
    n_poll_job["VeilVoiceApp::poll_job<br/>line 1523"]
    n_settings["VeilVoiceApp::settings<br/>line 1559"]
    n_file_tab["VeilVoiceApp::file_tab<br/>line 1671"]
    n_start_job["VeilVoiceApp::start_job<br/>line 1781"]
    n_guest_list["VeilVoiceApp::guest_list<br/>line 1892"]
    ...
    click n_poll_job href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/app.rs#L1523" "open the source"
    click n_settings href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/app.rs#L1559" "open the source"
    click n_file_tab href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/app.rs#L1671" "open the source"
    click n_start_job href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/app.rs#L1781" "open the source"
    click n_guest_list href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/app.rs#L1892" "open the source"
...
| `VeilVoiceApp::poll_job` <sub>fn</sub> | [1523](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/app.rs#L1523) | Take the result of a finished job without ever waiting for one. |
| `VeilVoiceApp::settings` <sub>fn</sub> | [1559](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/app.rs#L1559) | Draw the settings panel, with a policy floor shown as a floor rather than as a value somebody can move. |
| `VeilVoiceApp::file_tab` <sub>fn</sub> | [1671](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/app.rs#L1671) | Draw the File tab: pick a recording, veil it, write it somewhere else. |
| `VeilVoiceApp::start_job` <sub>fn</sub> | [1781](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/app.rs#L1781) | Hand the work to a thread, so the window keeps drawing while it runs. |
| `VeilVoiceApp::guest_list` <sub>fn</sub> | [1892](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/app.rs#L1892) | The Recording Studio: the voice first, then the take. |
| `VeilVoiceApp::studio_tab` <sub>fn</sub> | [1969](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/app.rs#L1969) | Draw the Recording Studio: record into the vault, veiled on the way in. |
| `VeilVoiceApp::start_preview` <sub>fn</sub> | [2332](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/app.rs#L2332) | Veil to this machine's own output, and say where it is going. |
| `VeilVoiceApp::check_failsafe` <sub>fn</sub> | [2384](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/app.rs#L2384) | Ask the safety catch what it makes of what is holding a microphone. |
| `VeilVoiceApp::watch_indicator` <sub>fn</sub> | [2460](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/app.rs#L2460) | Re-scan on a timer rather than every frame. |
| `VeilVoiceApp::watch_tab` <sub>fn</sub> | [2492](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/app.rs#L2492) | Draw the Watch tab: what is recording the screen, and what is allowed to. |
| `VeilVoiceApp::report_a_fault` <sub>fn</sub> | [2582](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/app.rs#L2582) | Say so if the last run ended badly, and offer the file. |
| `VeilVoiceApp::about_tab` <sub>fn</sub> | [2599](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/app.rs#L2599) | Draw the About tab: versions, where files live, and the companion list. |
| `paths_section` <sub>fn</sub> | [2738](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/app.rs#L2738) | Where this copy is keeping things, on this machine. |
| `device_picker` <sub>fn</sub> | [2798](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/app.rs#L2798) | A dropdown of devices that keeps working when the chosen one disappears. |
| `field` <sub>fn</sub> | [2824](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/app.rs#L2824) | One labelled read-only value, in the shape the About tab uses throughout. |
| `header_layout_tests` <sub>mod</sub> | [2832](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/app.rs#L2832) |  |
