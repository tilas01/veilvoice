...
<p align="center">
  <img src="https://raw.githubusercontent.com/tilas01/veilvoice/main/assets/diagrams/veilvoice-video.svg" alt="how veilvoice-video fits together" width="640">
</p>
...
flowchart TD
    ...
    n_ffmpeg["ffmpeg.rs<br/>305 lines"]
    n_page["page.rs<br/>1016 lines"]
...
|---|---:|---|
| [[`ffmpeg.rs`|File-veilvoice-video-ffmpeg]] | 305 | The video file, which needs a codec this project does not ship. |
...
| [[`page.rs`|File-veilvoice-video-page]] | 1016 | The picture: one still for a preview, and one page that plays. |
