...
*This page is [`docs/AUDIT.md`](https://github.com/tilas01/veilvoice/blob/main/docs/AUDIT.md) in the repository. The repository copy is the source; this is the same text with its links rewritten for the wiki.*
...
`[whitepaper](https://github.com/tilas01/veilvoice/blob/main/docs/Doc-WHITEPAPER)` in the README rendered as plain text on the
...
5. **The privileged half of tamper detection**, unchanged from the previous
   round and for the same reasons -- see [`ROADMAP.md`](https://github.com/tilas01/veilvoice/blob/main/docs/Doc-ROADMAP). Detection
