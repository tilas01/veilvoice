...
flowchart TD
    ...
    n_atrest["atrest.rs<br/>414 lines"]
...
| [[`atrest.rs`|File-veilvoice-cli-atrest]] | 414 | Encryption at rest for the recordings VeilVoice writes, and the passphrase prompts that feed it. |
