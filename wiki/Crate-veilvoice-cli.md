...
| [[`conversation.rs`|File-veilvoice-cli-conversation]] | 868 | veilvoice conversation -- several speakers, a voice each, and subtitles. |
...
| [[`record.rs`|File-veilvoice-cli-record]] | 359 | veilvoice record -- capture the veiled voice straight into an encrypted file. |
...
**5,758 functional lines of Rust** in this crate. A functional line is a line
