...
| [[`conversation.rs`|File-veilvoice-cli-conversation]] | 360 | veilvoice conversation -- several speakers, a voice each, and subtitles. |
...
| [[`main.rs`|File-veilvoice-cli-main]] | 1827 | veilvoice — the command-line interface. |
