...
| [[`main.rs`|File-veilvoice-cli-main]] | 1554 | veilvoice — the command-line interface. |
| [[`sentry.rs`|File-veilvoice-cli-sentry]] | 373 | veilvoice sentry -- canaries, baselines, and what changed since. |
