...
| [[`capture.rs`|File-veilvoice-cli-capture]] | 336 | veilvoice capture -- which screen recorders are running, and which of them you have said you meant to run. |
...
| [[`guard.rs`|File-veilvoice-cli-guard]] | 347 | veilvoice guard -- record what VeilVoice's files should be, and check them. |
...
| [[`lock.rs`|File-veilvoice-cli-lock]] | 330 | veilvoice lock manages the application lock from the command line. |
| [[`main.rs`|File-veilvoice-cli-main]] | 3439 | veilvoice, the command-line interface. |
...
**6,079 functional lines of Rust** in this crate. A functional line is a line
