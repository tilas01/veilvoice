...
|---|---:|---|
| [[`devices.rs`|File-veilvoice-audio-devices]] | 248 | Enumerating audio devices, and guessing which of them are virtual cables. |
...
| [[`live.rs`|File-veilvoice-audio-live]] | 860 | Live microphone scrambling. |
