...
| [[`lib.rs`|File-veilvoice-audio-lib]] | 222 | Everything between the sound hardware and veilvoice_core: device enumeration, file import and export, and the real-time capture → de-identify → playback path. |
| [[`live.rs`|File-veilvoice-audio-live]] | 252 | Live microphone scrambling. |
