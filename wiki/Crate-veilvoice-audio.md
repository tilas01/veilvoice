...
| [[`lib.rs`|File-veilvoice-audio-lib]] | 243 | Everything between the sound hardware and veilvoice_core: device enumeration, file import and export, and the real-time capture → de-identify → playback path. |
...
| [[`record.rs`|File-veilvoice-audio-record]] | 534 | Recording the veiled voice without it ever reaching unprotected memory. |
