...
| [[`lib.rs`|File-veilvoice-crypto-lib]] | 234 | Key derivation, post-quantum-hybrid key agreement, authenticated encryption and amnesic secret storage for VeilVoice. |
...
| [[`studio.rs`|File-veilvoice-crypto-studio]] | 936 | The studio vault: a key that exists only when both locks have been opened. |
