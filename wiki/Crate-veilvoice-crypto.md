...
| [[`lib.rs`|File-veilvoice-crypto-lib]] | 213 | Key derivation, post-quantum-hybrid key agreement, authenticated encryption and amnesic secret storage for VeilVoice. |
