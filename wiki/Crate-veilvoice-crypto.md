...
| [[`lock.rs`|File-veilvoice-crypto-lock]] | 1425 | The application lock: an Argon2id password verifier with a rate limit. |
| [[`privatefile.rs`|File-veilvoice-crypto-privatefile]] | 251 | Writing a file that only its owner can read. |
