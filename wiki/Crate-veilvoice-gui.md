...
|---|---:|---|
| [[`app.rs`|File-veilvoice-gui-app]] | 2918 | The VeilVoice desktop application: seven tabs, one window, no menus. |
...
| [[`main.rs`|File-veilvoice-gui-main]] | 213 | Entry point for the desktop application: open a window, hand it to veilvoice_gui::VeilVoiceApp, and get out of the way. |
...
| [[`studio.rs`|File-veilvoice-gui-studio]] | 1575 | The Recording Studio and the Recording Browser. |
