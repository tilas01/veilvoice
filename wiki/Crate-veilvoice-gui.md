...
|---|---:|---|
| [[`app.rs`|File-veilvoice-gui-app]] | 2760 | The VeilVoice desktop application: seven tabs, one window, no menus. |
...
| [[`prefs.rs`|File-veilvoice-gui-prefs]] | 637 | What the user has chosen about how the app looks and moves. |
