...
|---|---:|---|
| [[`app.rs`|File-veilvoice-gui-app]] | 2971 | The VeilVoice desktop application: seven tabs, one window, no menus. |
...
| [[`studio.rs`|File-veilvoice-gui-studio]] | 1736 | The Recording Studio and the Recording Browser. |
