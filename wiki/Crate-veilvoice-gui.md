...
|---|---:|---|
| [[`app.rs`|File-veilvoice-gui-app]] | 3051 | The VeilVoice desktop application: seven tabs, one window, no menus. |
...
| [[`studio.rs`|File-veilvoice-gui-studio]] | 1860 | The Recording Studio and the Recording Browser. |
