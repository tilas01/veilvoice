...
|---|---:|---|
| [[`app.rs`|File-veilvoice-gui-app]] | 1339 | The VeilVoice desktop application: seven tabs, one window, no menus. |
| [[`crashlog.rs`|File-veilvoice-gui-crashlog]] | 254 | Make a failure that produces no output produce some. |
| [[`lib.rs`|File-veilvoice-gui-lib]] | 64 | The VeilVoice desktop application: an egui/eframe front-end, monospace throughout — anonymise a file, scramble a microphone live, watch what is listening, manage the app lock, choose how the app looks, and an about panel that states the honest scope. |
