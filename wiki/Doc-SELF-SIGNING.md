...
*This page is [`docs/SELF_SIGNING.md`](https://github.com/tilas01/veilvoice/blob/main/docs/SELF_SIGNING.md) in the repository. The repository copy is the source; this is the same text with its links rewritten for the wiki.*
