...
[[veilvoice-video|Crate-veilvoice-video]] &middot; 149 lines &middot; [read the source](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-video/src/lib.rs)
...
149 lines defining **3 functions** (0 public), **1 type** and **2 constants**. Everything below is read out of the source, so it cannot disagree with the code.
...
<p align="center">
  <img src="https://raw.githubusercontent.com/tilas01/veilvoice/main/assets/diagrams/veilvoice-video/lib.svg" alt="what calls what in lib.rs" width="640">
</p>
...
flowchart TD
    n_from["Error::from<br/>line 95"]
    n_fmt["Error::fmt<br/>line 101"]
    n_source["Error::source<br/>line 111"]
    click n_from href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-video/src/lib.rs#L95" "open the source"
    click n_fmt href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-video/src/lib.rs#L101" "open the source"
    click n_source href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-video/src/lib.rs#L111" "open the source"
...
|---|---:|---|
| `VERSION` <sub>pub const</sub> | [62](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-video/src/lib.rs#L62) | Crate version string, surfaced in the About panel. |
| `SCOPE` <sub>pub const</sub> | [68](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-video/src/lib.rs#L68) | What a rendered video is worth, in the words a front end should show. |
| `Error` <sub>pub enum</sub> | [80](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-video/src/lib.rs#L80) | Everything that can go wrong in this crate. |
| `Error::from` <sub>fn</sub> | [95](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-video/src/lib.rs#L95) |  |
| `Error::fmt` <sub>fn</sub> | [101](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-video/src/lib.rs#L101) |  |
| `Error::source` <sub>fn</sub> | [111](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-video/src/lib.rs#L111) |  |
