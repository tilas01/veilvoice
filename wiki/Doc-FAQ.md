...
*This page is [`docs/FAQ.md`](https://github.com/tilas01/veilvoice/blob/main/docs/FAQ.md) in the repository. The repository copy is the source; this is the same text with its links rewritten for the wiki.*
