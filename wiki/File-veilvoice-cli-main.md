...
[[veilvoice-cli|Crate-veilvoice-cli]] &middot; 3523 lines &middot; [read the source](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-cli/src/main.rs)
...
3523 lines defining **29 functions** (0 public), **13 types** and **0 constants**. Everything below is read out of the source, so it cannot disagree with the code.
...
| `main` <sub>fn</sub> | [1323](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-cli/src/main.rs#L1323) | Parse the command line and turn a failure into an exit code and a message. |
| `run` <sub>fn</sub> | [1365](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-cli/src/main.rs#L1365) | Carry out one subcommand. |
| `run_ffmpeg` <sub>fn</sub> | [1933](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-cli/src/main.rs#L1933) | Roadmap items 87 and 88. |
| `list_volumes` <sub>fn</sub> | [2008](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-cli/src/main.rs#L2008) | Report the encrypted volumes this machine is offering. |
| `list_companions` <sub>fn</sub> | [2056](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-cli/src/main.rs#L2056) | Report every companion that means anything on this platform. |
| `offer_line` <sub>fn</sub> | [2089](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-cli/src/main.rs#L2089) | One line describing what VeilVoice can do about a missing companion. |
| `install_companion` <sub>fn</sub> | [2113](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-cli/src/main.rs#L2113) | Act on one named companion. |
| `Tuning` <sub>struct</sub> | [2196](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-cli/src/main.rs#L2196) | The engine settings a user can reach from the command line. |
| `reseed_range_from` <sub>fn</sub> | [2215](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-cli/src/main.rs#L2215) | Turn --reseed-range into a range, or into the reason it was not one. |
| `config` <sub>fn</sub> | [2235](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-cli/src/main.rs#L2235) | The de-identification settings a Tuning describes, with every figure clamped. |
| `describe_reseed_range` <sub>fn</sub> | [2254](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-cli/src/main.rs#L2254) | How a randomised roll range reads in the output. |
| `describe_reseed` <sub>fn</sub> | [2264](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-cli/src/main.rs#L2264) | How the seed-rolling setting reads in the output. |
| `AtRest` <sub>struct</sub> | [2273](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-cli/src/main.rs#L2273) | What to do with the result once it exists. |
| `anonymise` <sub>fn</sub> | [2283](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-cli/src/main.rs#L2283) | veilvoice anonymise: veil a recording and write it somewhere else. |
| `live` <sub>fn</sub> | [2426](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-cli/src/main.rs#L2426) | veilvoice live: veil the microphone as it is heard, with an optional preview. |
| `list_devices` <sub>fn</sub> | [2658](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-cli/src/main.rs#L2658) | veilvoice devices: every input and output this machine reports. |
| `read_named` <sub>pub(crate) fn</sub> | [2709](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-cli/src/main.rs#L2709) | Read a file, naming it if that fails. |
| `video_plan` <sub>pub(crate) fn</sub> | [2724](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-cli/src/main.rs#L2724) | Read a --size and an --fps into a render plan, saying what was decided. |
| `write_named` <sub>pub(crate) fn</sub> | [2741](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-cli/src/main.rs#L2741) | Write a file, naming it if that fails. |
| `clean` <sub>fn</sub> | [2746](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-cli/src/main.rs#L2746) | veilvoice clean: strip the metadata a file carries, in place. |
| `encrypt` <sub>fn</sub> | [2764](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-cli/src/main.rs#L2764) | veilvoice encrypt: seal a file, to a passphrase or to a public key. |
| `decrypt` <sub>fn</sub> | [2795](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-cli/src/main.rs#L2795) | veilvoice decrypt: open a sealed file, given the passphrase or the secret key. |
| `load_secret_key` <sub>fn</sub> | [2827](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-cli/src/main.rs#L2827) | Load a private key file, which is itself a password-locked container. |
| `keygen` <sub>fn</sub> | [2837](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-cli/src/main.rs#L2837) | veilvoice keygen: write a new key pair, refusing to overwrite either file. |
| `watch` <sub>fn</sub> | [2913](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-cli/src/main.rs#L2913) | Report, and keep reporting, what is using the microphone and camera. |
| `shred` <sub>fn</sub> | [3003](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-cli/src/main.rs#L3003) | Destroy a file's contents, then delete it. |
| `info` <sub>fn</sub> | [3072](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-cli/src/main.rs#L3072) | veilvoice info: the versions, and what this build was compiled to do. |
