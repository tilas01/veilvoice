...
*This page is [`docs/USING_THE_CRATES.md`](https://github.com/tilas01/veilvoice/blob/main/docs/USING_THE_CRATES.md) in the repository. The repository copy is the source; this is the same text with its links rewritten for the wiki.*
