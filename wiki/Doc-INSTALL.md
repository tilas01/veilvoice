...
*This page is [`docs/INSTALL.md`](https://github.com/tilas01/veilvoice/blob/main/docs/INSTALL.md) in the repository. The repository copy is the source; this is the same text with its links rewritten for the wiki.*
...
The scripts live in [`install/`](https://github.com/tilas01/veilvoice/blob/main/install). Each one downloads the release,
...
[REPRODUCIBLE_BUILDS.md](https://github.com/tilas01/veilvoice/blob/main/docs/Doc-REPRODUCIBLE-BUILDS).
