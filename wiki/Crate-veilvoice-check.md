...
|---|---:|---|
| [[`lib.rs`|File-veilvoice-check-lib]] | 463 | Check a VeilVoice release: a file's SHA-256, its line in a SHA256SUMS, and the detached OpenPGP signature over that list. |
