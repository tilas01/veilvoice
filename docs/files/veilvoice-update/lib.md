...
[`veilvoice-update`](../../../crates/veilvoice-update/README.md) &middot; 583 lines &middot; [read the source](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-update/src/lib.rs)
...
583 lines defining **8 functions** (4 public), **4 types** and **8 constants**. Everything below is read out of the source, so it cannot disagree with the code.
