...
[`veilvoice-setup`](../../../crates/veilvoice-setup/README.md) &middot; 171 lines &middot; [read the source](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-setup/src/lib.rs)
...
171 lines defining **3 functions** (0 public), **0 types** and **1 constant**. Everything below is read out of the source, so it cannot disagree with the code.
...
flowchart TD
    n_command["command<br/>line 90"]
    n_hide_console["hide_console<br/>line 104"]
    n_hide_console["hide_console<br/>line 114"]
    n_command --> n_hide_console
    click n_command href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-setup/src/lib.rs#L90" "open the source"
    click n_hide_console href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-setup/src/lib.rs#L104" "open the source"
    click n_hide_console href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-setup/src/lib.rs#L114" "open the source"
...
|---|---:|---|
| `VERSION` <sub>pub const</sub> | [78](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-setup/src/lib.rs#L78) | Crate version string, surfaced in the About panel. |
| `command` <sub>pub(crate) fn</sub> | [90](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-setup/src/lib.rs#L90) | Spawn without a console window. |
| `hide_console` <sub>fn</sub> | [104](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-setup/src/lib.rs#L104) | The Windows half of command. |
| `hide_console` <sub>fn</sub> | [114](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-setup/src/lib.rs#L114) | The everywhere-else half of command: nothing to hide, and no console is created by spawning a process in the first place. |
