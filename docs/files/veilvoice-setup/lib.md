...
[`veilvoice-setup`](../../../crates/veilvoice-setup/README.md) &middot; 170 lines &middot; [read the source](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-setup/src/lib.rs)
...
170 lines defining **3 functions** (0 public), **0 types** and **1 constant**. Everything below is read out of the source, so it cannot disagree with the code.
...
flowchart TD
    n_command["command<br/>line 89"]
    n_hide_console["hide_console<br/>line 103"]
    n_hide_console["hide_console<br/>line 113"]
    n_command --> n_hide_console
    click n_command href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-setup/src/lib.rs#L89" "open the source"
    click n_hide_console href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-setup/src/lib.rs#L103" "open the source"
    click n_hide_console href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-setup/src/lib.rs#L113" "open the source"
...
|---|---:|---|
| `VERSION` <sub>pub const</sub> | [77](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-setup/src/lib.rs#L77) | Crate version string, surfaced in the About panel. |
| `command` <sub>pub(crate) fn</sub> | [89](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-setup/src/lib.rs#L89) | Spawn without a console window. |
| `hide_console` <sub>fn</sub> | [103](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-setup/src/lib.rs#L103) | The Windows half of command. |
| `hide_console` <sub>fn</sub> | [113](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-setup/src/lib.rs#L113) | The everywhere-else half of command: nothing to hide, and no console is created by spawning a process in the first place. |
