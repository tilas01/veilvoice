...
<p align="center">
  <img src="../../../assets/banners/veilvoice-setup/space.svg" alt="space.rs" width="62%">
</p>

# `crates/veilvoice-setup/src/space.rs`

[`veilvoice-setup`](../../../crates/veilvoice-setup/README.md) &middot; 170 lines &middot; [read the source](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-setup/src/space.rs)
