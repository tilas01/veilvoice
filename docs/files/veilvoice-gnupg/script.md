...
<p align="center">
  <img src="../../../assets/banners/veilvoice-gnupg/script.svg" alt="script.rs" width="100%">
</p>

# `crates/veilvoice-gnupg/src/script.rs`

[`veilvoice-gnupg`](../../../crates/veilvoice-gnupg/README.md) &middot; 281 lines &middot; [read the source](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gnupg/src/script.rs)
...
<p align="center">
  <img src="../../../assets/diagrams/veilvoice-gnupg/script.svg" alt="what calls what in script.rs" width="640">
</p>
...
Generated from `crates/veilvoice-gnupg/src/script.rs`. On the website: [`website/reference/veilvoice-gnupg/script.html`](../../../website/reference/veilvoice-gnupg/script.html).
