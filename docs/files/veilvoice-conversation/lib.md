...
[`veilvoice-conversation`](../../../crates/veilvoice-conversation/README.md) &middot; 182 lines &middot; [read the source](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-conversation/src/lib.rs)
...
182 lines defining **3 functions** (0 public), **1 type** and **2 constants**. Everything below is read out of the source, so it cannot disagree with the code.

**The types it owns.**

- `enum Error` (line 97) -- Everything that can go wrong in this crate.
...
flowchart TD
    ...
    n_source["Error::source<br/>line 132"]
    click n_from href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-conversation/src/lib.rs#L111" "open the source"
    click n_fmt href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-conversation/src/lib.rs#L117" "open the source"
    click n_source href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-conversation/src/lib.rs#L132" "open the source"
...
|---|---:|---|
| `VERSION` <sub>pub const</sub> | [79](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-conversation/src/lib.rs#L79) | Crate version string, surfaced in the About panel. |
| `SCOPE` <sub>pub const</sub> | [85](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-conversation/src/lib.rs#L85) | What this crate does to a recording, in the words a front end should show. |
| `Error` <sub>pub enum</sub> | [97](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-conversation/src/lib.rs#L97) | Everything that can go wrong in this crate. |
| `Error::from` <sub>fn</sub> | [111](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-conversation/src/lib.rs#L111) |  |
| `Error::fmt` <sub>fn</sub> | [117](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-conversation/src/lib.rs#L117) |  |
| `Error::source` <sub>fn</sub> | [132](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-conversation/src/lib.rs#L132) |  |
