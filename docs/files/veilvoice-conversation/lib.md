...
[`veilvoice-conversation`](../../../crates/veilvoice-conversation/README.md) &middot; 163 lines &middot; [read the source](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-conversation/src/lib.rs)
...
163 lines defining **3 functions** (0 public), **1 type** and **2 constants**. Everything below is read out of the source, so it cannot disagree with the code.

**The types it owns.**

- `enum Error` (line 78) -- Everything that can go wrong in this crate.
...
flowchart TD
    n_from["Error::from<br/>line 92"]
    n_fmt["Error::fmt<br/>line 98"]
    n_source["Error::source<br/>line 113"]
    click n_from href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-conversation/src/lib.rs#L92" "open the source"
    click n_fmt href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-conversation/src/lib.rs#L98" "open the source"
    click n_source href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-conversation/src/lib.rs#L113" "open the source"
...
|---|---:|---|
| `VERSION` <sub>pub const</sub> | [60](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-conversation/src/lib.rs#L60) | Crate version string, surfaced in the About panel. |
| `SCOPE` <sub>pub const</sub> | [66](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-conversation/src/lib.rs#L66) | What this crate does to a recording, in the words a front end should show. |
| `Error` <sub>pub enum</sub> | [78](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-conversation/src/lib.rs#L78) | Everything that can go wrong in this crate. |
| `Error::from` <sub>fn</sub> | [92](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-conversation/src/lib.rs#L92) |  |
| `Error::fmt` <sub>fn</sub> | [98](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-conversation/src/lib.rs#L98) |  |
| `Error::source` <sub>fn</sub> | [113](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-conversation/src/lib.rs#L113) |  |
