...
[`veilvoice-check`](../../../crates/veilvoice-check/README.md) &middot; 463 lines &middot; [read the source](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-check/src/lib.rs)
...
|---|---:|---|
| `PUBLIC_KEY` <sub>pub const</sub> | [69](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-check/src/lib.rs#L69) | The project's signing key, in ASCII armour. |
| `FINGERPRINT` <sub>pub const</sub> | [81](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-check/src/lib.rs#L81) | The fingerprint, written out rather than derived. |
