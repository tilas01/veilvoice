...
[`veilvoice-policy`](../../../crates/veilvoice-policy/README.md) &middot; 167 lines &middot; [read the source](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-policy/src/lib.rs)
...
167 lines defining **4 functions** (0 public), **1 type** and **2 constants**. Everything below is read out of the source, so it cannot disagree with the code.

**The types it owns.**

- `enum Error` (line 94) -- Everything that can go wrong in this crate.
...
flowchart TD
    ...
    n_from["Error::from<br/>line 110"]
    n_fmt["Error::fmt<br/>line 116"]
    n_source["Error::source<br/>line 126"]
    click n_from href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-policy/src/lib.rs#L104" "open the source"
    click n_from href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-policy/src/lib.rs#L110" "open the source"
    click n_fmt href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-policy/src/lib.rs#L116" "open the source"
    click n_source href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-policy/src/lib.rs#L126" "open the source"
...
|---|---:|---|
| `VERSION` <sub>pub const</sub> | [76](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-policy/src/lib.rs#L76) | Crate version string, surfaced in the About panel. |
| `SCOPE` <sub>pub const</sub> | [82](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-policy/src/lib.rs#L82) | What a sealed policy is worth, in the words a front end should show. |
| `Error` <sub>pub enum</sub> | [94](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-policy/src/lib.rs#L94) | Everything that can go wrong in this crate. |
| `Error::from` <sub>fn</sub> | [104](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-policy/src/lib.rs#L104) |  |
| `Error::from` <sub>fn</sub> | [110](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-policy/src/lib.rs#L110) |  |
| `Error::fmt` <sub>fn</sub> | [116](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-policy/src/lib.rs#L116) |  |
| `Error::source` <sub>fn</sub> | [126](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-policy/src/lib.rs#L126) |  |
