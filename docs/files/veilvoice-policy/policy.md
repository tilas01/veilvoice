...
<p align="center">
  <img src="../../../assets/banners/veilvoice-policy/policy.svg" alt="policy.rs" width="62%">
</p>

# `crates/veilvoice-policy/src/policy.rs`

[`veilvoice-policy`](../../../crates/veilvoice-policy/README.md) &middot; 991 lines &middot; [read the source](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-policy/src/policy.rs)
