...
[`veilvoice-crypto`](../../../crates/veilvoice-crypto/README.md) &middot; 223 lines &middot; [read the source](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-crypto/src/lib.rs)
...
223 lines defining **1 function** (0 public), **1 type** and **1 constant**. Everything below is read out of the source, so it cannot disagree with the code.
...
flowchart TD
    n_fmt["Error::fmt<br/>line 172"]
    click n_fmt href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-crypto/src/lib.rs#L172" "open the source"
...
|---|---:|---|
| `VERSION` <sub>pub const</sub> | [93](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-crypto/src/lib.rs#L93) | Crate version string, surfaced in the About panel. |
| `Error` <sub>pub enum</sub> | [102](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-crypto/src/lib.rs#L102) | Everything that can go wrong in this crate. |
| `Error::fmt` <sub>fn</sub> | [172](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-crypto/src/lib.rs#L172) |  |
