...
<p align="center">
  <img src="../../../assets/banners/veilvoice-crypto/lib.svg" alt="lib.rs" width="62%">
</p>

# `crates/veilvoice-crypto/src/lib.rs`

[`veilvoice-crypto`](../../../crates/veilvoice-crypto/README.md) &middot; 242 lines &middot; [read the source](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-crypto/src/lib.rs)
...
242 lines defining **1 function** (0 public), **1 type** and **1 constant**. Everything below is read out of the source, so it cannot disagree with the code.

**The types it owns.**

- `enum Error` (line 106) -- Everything that can go wrong in this crate.
...
flowchart TD
    n_fmt["Error::fmt<br/>line 186"]
    click n_fmt href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-crypto/src/lib.rs#L186" "open the source"
...
|---|---:|---|
| `VERSION` <sub>pub const</sub> | [97](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-crypto/src/lib.rs#L97) | Crate version string, surfaced in the About panel. |
| `Error` <sub>pub enum</sub> | [106](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-crypto/src/lib.rs#L106) | Everything that can go wrong in this crate. |
| `Error::fmt` <sub>fn</sub> | [186](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-crypto/src/lib.rs#L186) |  |
