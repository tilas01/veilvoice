...
[`veilvoice-crypto`](../../../crates/veilvoice-crypto/README.md) &middot; 214 lines &middot; [read the source](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-crypto/src/lib.rs)
...
214 lines defining **1 function** (0 public), **1 type** and **1 constant**. Everything below is read out of the source, so it cannot disagree with the code.

**The types it owns.**

- `enum Error` (line 100) -- Everything that can go wrong in this crate.
...
flowchart TD
    n_fmt["Error::fmt<br/>line 166"]
    click n_fmt href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-crypto/src/lib.rs#L166" "open the source"
...
|---|---:|---|
| `VERSION` <sub>pub const</sub> | [91](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-crypto/src/lib.rs#L91) | Crate version string, surfaced in the About panel. |
| `Error` <sub>pub enum</sub> | [100](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-crypto/src/lib.rs#L100) | Everything that can go wrong in this crate. |
| `Error::fmt` <sub>fn</sub> | [166](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-crypto/src/lib.rs#L166) |  |
