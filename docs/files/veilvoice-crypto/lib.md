...
[`veilvoice-crypto`](../../../crates/veilvoice-crypto/README.md) &middot; 234 lines &middot; [read the source](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-crypto/src/lib.rs)
...
234 lines defining **1 function** (0 public), **1 type** and **1 constant**. Everything below is read out of the source, so it cannot disagree with the code.

**The types it owns.**

- `enum Error` (line 104) -- Everything that can go wrong in this crate.
...
flowchart TD
    n_fmt["Error::fmt<br/>line 179"]
    click n_fmt href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-crypto/src/lib.rs#L179" "open the source"
...
|---|---:|---|
| `VERSION` <sub>pub const</sub> | [95](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-crypto/src/lib.rs#L95) | Crate version string, surfaced in the About panel. |
| `Error` <sub>pub enum</sub> | [104](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-crypto/src/lib.rs#L104) | Everything that can go wrong in this crate. |
| `Error::fmt` <sub>fn</sub> | [179](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-crypto/src/lib.rs#L179) |  |
