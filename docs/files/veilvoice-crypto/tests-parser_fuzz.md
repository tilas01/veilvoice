...
<p align="center">
  <img src="../../../assets/banners/veilvoice-crypto/tests-parser_fuzz.svg" alt="parser_fuzz.rs" width="100%">
</p>
...
Generated from `crates/veilvoice-crypto/tests/parser_fuzz.rs`. On the website: [`website/reference/veilvoice-crypto/tests-parser_fuzz.html`](../../../website/reference/veilvoice-crypto/tests-parser_fuzz.html).
