...
<p align="center">
  <img src="../../../assets/banners/veilvoice-watch/proc.svg" alt="proc.rs" width="100%">
</p>

# `crates/veilvoice-watch/src/proc.rs`

[`veilvoice-watch`](../../../crates/veilvoice-watch/README.md) &middot; 274 lines &middot; [read the source](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-watch/src/proc.rs)
...
274 lines defining **4 functions** (1 public), **0 types** and **1 constant**. Everything below is read out of the source, so it cannot disagree with the code.

**What happens when it runs.** These are the ways in: public, and nothing else in this file calls them, so they are what an outside caller reaches first.

- `running` (line 64) -- Every process name this build can see, lower-cased and without a path.
...
<p align="center">
  <img src="../../../assets/diagrams/veilvoice-watch/proc.svg" alt="what calls what in proc.rs" width="640">
</p>
...
flowchart TD
    n_running(["running<br/>line 64"])
    n_linux["linux<br/>line 84"]
    n_spawned["spawned<br/>line 117"]
    n_parse["parse<br/>line 169"]
    n_running --> n_linux
    n_running --> n_spawned
    n_spawned --> n_parse
    click n_running href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-watch/src/proc.rs#L64" "open the source"
    click n_linux href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-watch/src/proc.rs#L84" "open the source"
    click n_spawned href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-watch/src/proc.rs#L117" "open the source"
    click n_parse href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-watch/src/proc.rs#L169" "open the source"
...
|---|---:|---|
| `running` <sub>pub fn</sub> | [64](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-watch/src/proc.rs#L64) | Every process name this build can see, lower-cased and without a path. |
| `linux` <sub>fn</sub> | [84](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-watch/src/proc.rs#L84) | Walk /proc and read each process's own name. |
| `spawned` <sub>fn</sub> | [117](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-watch/src/proc.rs#L117) | Ask the system's own process lister. |
| `parse` <sub>fn</sub> | [169](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-watch/src/proc.rs#L169) | Pull process names out of a listing. |
| `SCOPE` <sub>pub const</sub> | [191](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-watch/src/proc.rs#L191) | What a reader has to be told, in the words to show them. |

---

Generated from `crates/veilvoice-watch/src/proc.rs`. On the website: [`website/reference/veilvoice-watch/proc.html`](../../../website/reference/veilvoice-watch/proc.html).
