...
<p align="center">
  <img src="../../../assets/banners/veilvoice-verify/fetch.svg" alt="fetch.rs" width="62%">
</p>

# `crates/veilvoice-verify/src/fetch.rs`

[`veilvoice-verify`](../../../crates/veilvoice-verify/README.md) &middot; 337 lines &middot; [read the source](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-verify/src/fetch.rs)
...
<p align="center">
  <img src="../../../assets/diagrams/veilvoice-verify/fetch.svg" alt="what calls what in fetch.rs" width="640">
</p>
...
Generated from `crates/veilvoice-verify/src/fetch.rs`. On the website: [`website/reference/veilvoice-verify/fetch.html`](../../../website/reference/veilvoice-verify/fetch.html).
