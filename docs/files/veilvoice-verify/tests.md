...
<p align="center">
  <img src="../../../assets/banners/veilvoice-verify/tests.svg" alt="tests.rs" width="62%">
</p>

# `crates/veilvoice-verify/src/tests.rs`

[`veilvoice-verify`](../../../crates/veilvoice-verify/README.md) &middot; 1671 lines &middot; [read the source](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-verify/src/tests.rs)
...
flowchart TD
    ...
    n_what_is_inside_an_archive_is_counted_rather_than_glanced_at["what_is_inside_an_archive_is_counted_<br/>rather_than_glanced_at<br/>line 1573"]
    n_tar_on_this_machine["tar_on_this_machine<br/>line 1664"]
    n_a_contents_list_with_nothing_to_check_it_against_is_unusable --> n_matches_name
    n_what_is_inside_an_archive_is_counted_rather_than_glanced_at --> n_tar_on_this_machine
...
| `the_key_a_download_carries_is_never_used_to_check_anything` <sub>fn</sub> | [1408](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-verify/src/tests.rs#L1408) | Roadmap item 164. |
| `the_carried_key_is_looked_at_before_anything_is_checked` <sub>fn</sub> | [1444](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-verify/src/tests.rs#L1444) | Roadmap item 164. |
| `an_archive_is_checked_against_the_signed_list_before_it_is_opened` <sub>fn</sub> | [1483](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-verify/src/tests.rs#L1483) | Roadmap item 164. |
