...
<p align="center">
  <img src="../../../assets/banners/veilvoice-gui/soundbar.svg" alt="soundbar.rs" width="62%">
</p>

# `crates/veilvoice-gui/src/soundbar.rs`

[`veilvoice-gui`](../../../crates/veilvoice-gui/README.md) &middot; 782 lines &middot; [read the source](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/soundbar.rs)
