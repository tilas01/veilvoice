...
<p align="center">
  <img src="../../../assets/banners/veilvoice-gui/theme.svg" alt="theme.rs" width="62%">
</p>

# `crates/veilvoice-gui/src/theme.rs`

[`veilvoice-gui`](../../../crates/veilvoice-gui/README.md) &middot; 813 lines &middot; [read the source](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/theme.rs)
