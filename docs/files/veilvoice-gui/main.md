...
[`veilvoice-gui`](../../../crates/veilvoice-gui/README.md) &middot; 231 lines &middot; [read the source](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/main.rs)
...
231 lines defining **3 functions** (0 public), **0 types** and **3 constants**. Everything below is read out of the source, so it cannot disagree with the code.
...
flowchart TD
    n_answered_without_a_window["answered_without_a_window<br/>line 116"]
    n_answered_without_a_window["answered_without_a_window<br/>line 157"]
    n_main["main<br/>line 161"]
    n_main --> n_answered_without_a_window
    click n_answered_without_a_window href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/main.rs#L116" "open the source"
    click n_answered_without_a_window href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/main.rs#L157" "open the source"
    click n_main href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/main.rs#L161" "open the source"
...
| `answered_without_a_window` <sub>fn</sub> | [116](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/main.rs#L116) | Answer --help and --version before a window is opened. |
| `answered_without_a_window` <sub>fn</sub> | [157](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/main.rs#L157) |  |
| `main` <sub>fn</sub> | [161](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/main.rs#L161) |  |
