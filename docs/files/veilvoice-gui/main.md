...
[`veilvoice-gui`](../../../crates/veilvoice-gui/README.md) &middot; 205 lines &middot; [read the source](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/main.rs)
...
205 lines defining **3 functions** (0 public), **0 types** and **3 constants**. Everything below is read out of the source, so it cannot disagree with the code.
...
flowchart TD
    n_answered_without_a_window["answered_without_a_window<br/>line 112"]
    n_answered_without_a_window["answered_without_a_window<br/>line 139"]
    n_main["main<br/>line 143"]
    n_main --> n_answered_without_a_window
    click n_answered_without_a_window href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/main.rs#L112" "open the source"
    click n_answered_without_a_window href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/main.rs#L139" "open the source"
    click n_main href "https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/main.rs#L143" "open the source"
...
| `answered_without_a_window` <sub>fn</sub> | [112](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/main.rs#L112) | Answer --help and --version before a window is opened. |
| `answered_without_a_window` <sub>fn</sub> | [139](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/main.rs#L139) |  |
| `main` <sub>fn</sub> | [143](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/main.rs#L143) |  |
