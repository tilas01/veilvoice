...
<p align="center">
  <img src="../../../assets/banners/veilvoice-gui/palettes.svg" alt="palettes.rs" width="62%">
</p>

# `crates/veilvoice-gui/src/palettes.rs`

[`veilvoice-gui`](../../../crates/veilvoice-gui/README.md) &middot; 714 lines &middot; [read the source](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/palettes.rs)
