...
<p align="center">
  <img src="../../../assets/banners/veilvoice-gui/progress.svg" alt="progress.rs" width="62%">
</p>

# `crates/veilvoice-gui/src/progress.rs`

[`veilvoice-gui`](../../../crates/veilvoice-gui/README.md) &middot; 539 lines &middot; [read the source](https://github.com/tilas01/veilvoice/blob/main/crates/veilvoice-gui/src/progress.rs)
...
<p align="center">
  <img src="../../../assets/diagrams/veilvoice-gui/progress.svg" alt="what calls what in progress.rs" width="640">
</p>
...
Generated from `crates/veilvoice-gui/src/progress.rs`. On the website: [`website/reference/veilvoice-gui/progress.html`](../../../website/reference/veilvoice-gui/progress.html).
